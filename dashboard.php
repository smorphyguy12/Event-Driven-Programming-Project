                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="avatar-sm bg-blue rounded">
                                                <i class="fa fa-sms avatar-title font-22 text-white"></i>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="text-end">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="avatar-sm bg-success rounded">
                                                <i class="fa fa-envelope avatar-title font-22 text-white"></i>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="text-end">
                                                <h3 class="text-dark my-1"><span data-plugin="counterup">1576</span></h3>
                                                <p class="text-muted mb-1 text-truncate">EMAIL MESSAGING</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-end">
                                                ...
                                                <p class="text-muted mb-1 text-truncate">CALENDAR</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt-3">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="avatar-sm bg-info rounded">
                                                <i class="fa-fa- notepad title font-22 text-white"></i>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="text-end">
