...
if($_SERVER['REQUEST_METHOD'] === "POST"){
    ...
    if ($password !== $confirm_pass) {
        ...
        $sql = "INSERT INTO `students` (student_id, fullname, course, email, password) VALUES ('$student_id', '$fullname', '$courses', '$email', '$hash_pass')";
                        ...
                        <div class="card-body p-4">
                            ...
                            <form method="POST">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="student_id" id="student_id" placeholder="Enter your Student ID" require>
                                </div>
                                <div class="mb-3">
